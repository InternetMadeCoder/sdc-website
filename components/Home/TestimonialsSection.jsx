...
const TestimonialsSection = () => {
    ...
    return (
        <div className="py-8 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 bg-white flex flex-col gap-16 items-start relative z-30 md:items-center white-section">
            <h2 className="text-5xl mb-8">OUR DRIVING FORCE</h2>
            
            {/* Static testimonials */}
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 lg:max-w-7xl">
                {staticTestimonials.map((testimonial) => (
                    <div key={testimonial.id} className="relative pt-16">
                        ...
                        <div className="bg-gradient-to-br from-indigo-950 via-purple-900 to-blue-950 text-white rounded-2xl p-4 pt-16 min-h-[280px] flex flex-col items-center">
