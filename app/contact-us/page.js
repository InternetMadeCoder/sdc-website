    ...
    return (
        <div className="overflow-hidden bg-[#eaeaea] white-section">
            ...
            <div className="bg-[url(/bg/contact-bg.webp)] bg-cover h-[512px] text-white flex flex-col justify-center gap-8 px-4 xl:px-48 lg:px-48 md:px-32 sm:pr-8 sm:pl-32">
                <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold opacity-0 ${
                ...
                <p className={`text-base md:text-lg lg:text-xl lg:w-3/4 opacity-0 ${
                    showContent ? 'animate-slide-up' : ''
                }`}
                style={{
                    animation: showContent ? 'slideUp 0.8s ease 0.3s forwards' : 'none',
                }}>
                    Get In Touch! We'd love to hear from you! If you have any questions or anything to share, 
            ...
            <div className="bg-[#eaeaea] mx-4 sm:mx-6 md:mx-12 lg:mx-20 xl:mx-28 lg:-mt-32 mb-16">
                <div className="py-8 lg:py-16 px-2 md:px-8 flex flex-col lg:flex-row justify-center items-start gap-16 w-full">
                    ...
                    <div className="flex flex-col max-w-96 gap-8 w-full">
                        {/* Phone Card */}
                        <div className={`contact-card bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl 
                            transition-all duration-300 flex items-start gap-4 opacity-0 border-l-4 border-[#D34747]`}
                            style={{
                                animation: showContent ? 'fadeIn 0.5s ease 0.4s forwards' : 'none',
                            }}>
                        ...
                        <div className={`contact-card bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl 
                            transition-all duration-300 flex items-start gap-4 opacity-0 border-l-4 border-[#D34747]`}
                            style={{
                                animation: showContent ? 'fadeIn 0.5s ease 0.6s forwards' : 'none',
                            }}>
                            <div className="p-3 bg-red-50 rounded-full">
                        ...
                        <div className={`contact-card bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl 
                            transition-all duration-300 flex items-start gap-4 opacity-0 border-l-4 border-[#D34747]`}
                            style={{
                                animation: showContent ? 'fadeIn 0.5s ease 0.8s forwards' : 'none',
                            }}>
                            <div className="p-3 bg-red-50 rounded-full">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-900 mb-2">Software Development Centre (SDC)</p>
                    ...
                    {/* Contact Form */}
                    <div className={`bg-white rounded-xl shadow-2xl p-8 lg:p-10 w-full lg:w-auto max-w-2xl opacity-0
                        border-t-4 border-[#D34747]`}
                        style={{
                            animation: showContent ? 'fadeIn 0.5s ease 1s forwards' : 'none',
                        }}>
                        <div className="max-w-md mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-2">Reach Out To Us</h2>
                            <p className="text-gray-600 mb-8">
                                If you have any questions or anything to share, feel free to drop us a message.
                            </p>
